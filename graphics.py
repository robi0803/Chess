...
class Graphics():
    ...
    def createImages(self):
        ...
        image = self.WhiteKingImage, anchor = "nw", tags = ("token", "white", "king"))
        ...
        fill = "white", font = ("system", 20), state = "hidden", tags = "resumeText")
        ...
        fill = "white", font = ("system", 20), state = "hidden", tags = "restartText")

        self.canvas.create_rectangle(3 * self.k.space, 3.65 * self.k.space, 5 * self.k.space,
        4.35 * self.k.space, fill = "black", activefill = "gray", tags = "restartBg",
        state = "hidden")
        ...
        text = "Black Wins!", fill = "white", font = ("system", 20), state = "hidden",
        tags = "blkWin")


        # promotion menu background
        self.canvas.create_text(self.k.width / 2, self.k.height / 3, text = "Choose Promotion",
        fill = "black", font = ("system", 20), state = "hidden", tags = "promotionText")

        self.canvas.create_rectangle(2*self.k.space, 4*self.k.space, 3*self.k.space,
        5*self.k.space, fill = "gray", activefill = "white", tags = ("prom", "rookRec"),
        state = "hidden")

        self.canvas.create_rectangle(3*self.k.space, 4*self.k.space, 4*self.k.space,
        5*self.k.space, fill = "gray", activefill = "white", tags = ("prom", "bishopRec"),
        state = "hidden")

        self.canvas.create_rectangle(4*self.k.space, 4*self.k.space, 5*self.k.space,
        5*self.k.space, fill = "gray", activefill = "white", tags = ("prom", "queenRec"),
        state = "hidden")

        self.canvas.create_rectangle(5*self.k.space, 4*self.k.space, 6*self.k.space,
        5*self.k.space, fill = "gray", activefill = "white", tags = ("prom", "knightRec"),
        state = "hidden")
